...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Caritas.Brigadas.Domain.Entities.Patient", b =>
                {
                    ...
                    b.Property<string>("DataCaptureSource")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<Guid?>("SourceBrigadeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrganizationId", "ClientOperationId")
                        .HasDatabaseName("IX_patients_OrganizationId_ClientOperationId");
                    ...
                    b.HasIndex("OrganizationId", "IdempotencyKey")
                        .HasDatabaseName("IX_patients_OrganizationId_IdempotencyKey");
                    ...
                    b.HasIndex("OrganizationId", "LocalPatientId")
                        .HasDatabaseName("IX_patients_OrganizationId_LocalPatientId");

                    b.HasIndex("OrganizationId", "PatientFolio")
                        .IsUnique();

                    b.HasIndex("OrganizationId", "SourceBrigadeId")
                        .HasDatabaseName("IX_patients_OrganizationId_SourceBrigadeId");

                    b.HasIndex("OrganizationId", "SourceBrigadeId", "LocalPatientId")
                        .IsUnique()
                    ...
                    b.HasIndex("OrganizationId", "SyncStatus")
                        .HasDatabaseName("IX_patients_OrganizationId_SyncStatus");
            ...
            modelBuilder.Entity("Caritas.Brigadas.Domain.Entities.Brigade", b =>
                {
                    b.HasOne("Caritas.Brigadas.Domain.Entities.Community", null)
                        .WithMany()
                        .HasForeignKey("CommunityId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Caritas.Brigadas.Domain.Entities.MobileUnit", null)
                        .WithMany()
                        .HasForeignKey("MobileUnitId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("Caritas.Brigadas.Domain.Entities.RolePermission", b =>
                {
                    b.HasOne("Caritas.Brigadas.Domain.Entities.Permission", null)
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Caritas.Brigadas.Domain.Entities.Role", null)
                        .WithMany()
