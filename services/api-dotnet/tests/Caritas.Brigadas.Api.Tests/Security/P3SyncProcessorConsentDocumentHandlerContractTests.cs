...
public sealed class P3SyncProcessorConsentDocumentHandlerContractTests
{
    ...
    [Fact]
    public void SyncBatchProcessor_DoesNotContainDirectConsentDocumentLogicAfterExtraction()
    {
        ...
        AssertRequiredTokens(source, requiredTokens, "SyncBatchProcessor consent document wrapper");
