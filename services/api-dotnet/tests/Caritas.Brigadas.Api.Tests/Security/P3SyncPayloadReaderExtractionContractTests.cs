...
public sealed class P3SyncPayloadReaderExtractionContractTests
{
    ...
    {
        var source = File.ReadAllText(GetInfrastructurePath("Sync", "SyncBatchProcessor.cs")) + File.ReadAllText(GetInfrastructurePath("Sync", "PatientSyncEventHandler.cs")) + File.ReadAllText(GetInfrastructurePath("Sync", "PatientVisitSyncEventHandler.cs")) + File.ReadAllText(GetInfrastructurePath("Sync", "ServiceEncounterSyncEventHandler.cs")) + File.ReadAllText(GetInfrastructurePath("Sync", "VitalSignsSyncEventHandler.cs")) + File.ReadAllText(GetInfrastructurePath("Sync", "FormResponseSyncEventHandler.cs")) + File.ReadAllText(GetInfrastructurePath("Sync", "ConsentDocumentSyncEventHandler.cs")) + File.ReadAllText(GetInfrastructurePath("Sync", "MedicalReferralSyncEventHandler.cs")) + File.ReadAllText(GetInfrastructurePath("Sync", "MedicationDeliverySyncEventHandler.cs"));
