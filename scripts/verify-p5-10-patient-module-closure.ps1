...
$PhaseEvidence = @(
    ...
    @{ Phase = "P5.9"; Filter = "P5_09_PATIENT*" },
    @{ Phase = "P5.9.1"; Filter = "P5_09_1*PATIENT*" }
)
...
$VerifierFilters = @(
    ...
    "verify-p5-07*.ps1",
    "verify-p5-08*.ps1",
    "verify-p5-09-patient-create-idempotency.ps1",
    "verify-p5-09-1-patient-create-atomic-idempotency-backstop.ps1"
)
