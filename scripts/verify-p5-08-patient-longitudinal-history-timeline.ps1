...
$ForbiddenTokens = @(
    ...
    "visit.ArrivalTime.Value",
    "encounter.StartedAt.Value",
    "visits.Where(visit => visit.ArrivalTime.HasValue)",
    "encounters.Where(encounter => encounter.StartedAt.HasValue)",
    ".ToArrayAsync(cancellationToken);        var timeline",
